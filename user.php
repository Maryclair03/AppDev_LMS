...
<head>
    ...
    <style>
        body {
            background-image: url('path/to/your/mainbg.jpg');
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <!-- Sidebar -->
        <ul class="navbar-nav sidebar sidebar-dark accordion" style="background-color: #42abff;" id="accordionSidebar">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!-- Topbar -->
                <nav class="navbar navbar-expand navbar-dark topbar mb-4 static-top shadow" style="background-color: #ffffff;">
                    <a class="navbar-brand" href="#">
                        <img src="image/logo2.png" alt="Logo"> <!-- Logo image -->
                    </a>
                ...
                <div class="container-fluid">
					...
					<button class="mb-2 btn btn-lg btn-success" style="background-color: #0070ff;" href="#" data-toggle="modal" data-target="#addModal"><span class="fa fa-plus"></span> Add User</button>
                    <!-- DataTales Example -->
