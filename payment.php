        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
					...
					<div class="row">
						<button class="ml-3 mb-3 btn btn-lg btn-primary" style="background-color: #0070ff;" href="#" data-toggle="modal" data-target="#addModal"><span class="fa fa-plus"></span> New Payment</button>
					</div>
                    <!-- DataTales Example -->
