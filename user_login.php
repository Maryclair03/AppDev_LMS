                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form method="POST" class="user" action="login.php">
                                        ...
                                        <div class="form-group">
                                            <input type="number" class="form-control form-control-user" name="ref_number" placeholder="Referrence  Number" required="required">
                                        </div>
                                        <?php 
                                            session_start();
                                    ...
                                    <a href="index.php" class="">login admin account here.</a>
                                    </div>
                                </div>
                            </div>
